...
We chose a mouse cortex time series data set GSE151565, which contains a total of 77 samples every 3 hours, for 36 hours.
We computed the dependence structure of the genes as well as the variances of marginal distributions using the 12 time point 0 samples and computed the means of gene expressions at each time point.
