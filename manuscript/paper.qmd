...
For Guassian copulas, this is a choice of a covariance matrix.
...
We note that, unlike many timeseries methods that consider correlation across time points, the dependence here is between genes within the same sample and no dependence between samples or timepoints is generated.
...
Metabolomics data was obtained from MetaboAnalyst (https://api2.xialab.ca/api/download/metaboanalyst/plasma_nmr.csv).
