...
This two-step process makes it challenging to compare on theoretical grounds to our proposed methods since it will depended upon parameters such as the number of buckets used.
