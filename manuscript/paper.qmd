...
The `corpcor` package <!-- TODO cite --> computes a James-Stein type shrinkage estimator for the covariance matrix.
...
The R package [SPsimSeq](https://github.com/CenterForStatistics-UGent/SPsimSeq) <!-- TODO cite --> provides a dedicated RNA-seq and scRNA-seq simulator using a NORTA approach to simulate gene dependence.
...
The [scDesign2](https://genomebiology.biomedcentral.com/articles/10.1186/s13059-021-02367-2) simulator <!-- TODO cite --> for scRNA-seq uses NORTA and, like our method, uses the approach of estimating the correlation matrix from the normalized dataset.
