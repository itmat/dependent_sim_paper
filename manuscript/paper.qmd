...
Another package that optimizes the speed of random multivariate normal vector generation is the `mvnfast` package for R [@mvnfast], however, we show that this does not provide a meaningful speedup for our use-cases due to the reliance on the Cholesky decomposition, see @fig-intro d.
