...
```{r}
#| label: fig-benchmark
#| fig-cap: "Comparison of (a) run time and (b) memory usage for our methods and SPsimSeq. 100 samples were generated with a varying number of genes. GSE151564 dataset was randomly subsetted to have the required number of genes to be used as the reference data set."
#| fig-width: 8
#| fig-height: 4
library(tidyverse)
library(patchwork)
